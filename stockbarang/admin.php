                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <input type="text" name="leveladmin" value="<?=$leveladmin;?>" class="form-control" placeholder="Level" required>
                                                                <br>
      ...
      <div class="modal-content">
        ...
        <form method="post">
            <div class="modal-body">
                ...
                <br>
                <input type="text" name="level" placeholder="level" class="form-control" required>
                <br>
